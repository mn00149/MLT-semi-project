...
<div class="container">
  ...
  <ul class="list-group">
	...
	<li class="list-group-item">주소: (${mdto.zipcode }) ${mdto.address1 } ${mdto.address2 } 
  ...
  <ul class="list-group">
	...
	<label class="btn btn-primary" for="btn2">pay머니</label> 
	<input type="radio" class="btn-check" name="payment" value="pay카드" id="btn3">
	<label class="btn btn-primary" for="btn3">pay카드</label> 
